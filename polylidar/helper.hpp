...
inline double getMaxDimTriangle(size_t t, delaunator::Delaunator &delaunay, mdarray &points) {
...
inline void trackExtremePoint(size_t pi, mdarray &points, ExtremePoint &exPoint, size_t he){
